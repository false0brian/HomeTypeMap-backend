...
class AppUser(Base):
    ...
    user_key: Mapped[str] = mapped_column(String(80), nullable=False, unique=True)
    ...
    __table_args__ = (
        ...
        Index("ix_app_users_user_key", "user_key"),
    )
...
class QuoteRequest(Base):
    ...
    requester_email: Mapped[str | None] = mapped_column(String(160))
